 ...
 * @author anctWin10
 */
public class QLDonHangChiTiet_v2 extends javax.swing.JDialog {
    DonHangChiTietDAO dao = new DonHangChiTietDAO();
//    void fillComboBoxMaSP(){
//        DefaultComboBoxModel model = (DefaultComboBoxModel) cobMaSP.getModel();
//        model.removeAllElements();
//        DonHangChiTiet DHCL = (DonHangChiTiet) cobMaSP.getSelectedItem();
//        if(DHCL != null){
//            List<MASP> list = khdao.selectByChuyenDe(chuyenDe.getMaCD());
//            for(KhoaHoc kh: list){
//                model.addElement(kh);
//            }
...
//    }
    ...
    void getTenSP() {
        String tenSP = cobMaSP.getItemAt(WIDTH);
    ...
    public QLDonHangChiTiet_v2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    boolean validateInput() {
        ...
        String matKhau = cobMaSP.getItemAt(WIDTH).trim();
    ...
    DonHangChiTiet getForm(){
        ...
        DHCT.setMaSP(cobMaSP.getItemAt(WIDTH));
    ...
    void setForm(DonHangChiTiet model) {
        ...
        cobMaSP.setActionCommand(model.getMaSP());
    ...
    void delete() {
        if(MsgBox.confirm(this, "Bạn thực sự muốn xóa Tài Khoản! này?")) {
            String maTK = cobMaSP.getItemAt(WIDTH);
            try {
                dao.delete(maTK);
                this.fillTable();
                this.clear();
    ...
    private void initComponents() {
        ...
        cobMaSP = new javax.swing.JComboBox<>();
        ...
        cobMaSP.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cobMaSP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cobMaSPActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(cobMaSP, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(cobMaSP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void cobMaSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cobMaSPActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cobMaSPActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLDonHangChiTiet_v2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QLDonHangChiTiet_v2 dialog = new QLDonHangChiTiet_v2(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox<String> cobMaSP;
